...
ps1abc=[]
def open1abc(inp_text,inp_wav_dir,exp_name,bert_pretrained_dir,ssl_pretrained_dir,pretrained_s2G_path,gpu_numbers1a="0",gpu_numbers1Ba="0",gpu_numbers1c="0"):
    global ps1abc
...
SoVITS_weight_root="SoVITS_weights" # TODO 放到合适的位置
